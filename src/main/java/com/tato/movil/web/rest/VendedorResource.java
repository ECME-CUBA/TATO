...
/**
 * REST controller for managing {@link com.tato.movil.domain.Vendedor}.
 */
@RestController
@RequestMapping("/api")
public class VendedorResource {
    ...
    public ResponseEntity<Vendedor> updateVendedor(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, vendedor.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Vendedor> partialUpdateVendedor(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, vendedor.getId().toString())
        );
    }
