...
describe('Articulo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'articulo', component: ArticuloComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.articulos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
